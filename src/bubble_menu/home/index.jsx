...
<nav className="menu-wrapper">
  ...
  <a href="https://landing.shinixagami.net/waveportal"  target="_self" className="menu-item home-element-1"  alt="1st element">  <FcTodoList />  </a>
  
   <a href="#" className="menu-item green"> <FcAbout /> </a>
   <a href="#" className="menu-item red">  <FcAbout /> </a>
  
   <a href="https://landing.shinixagami.net/waveportal" target="_self" className="menu-item purple"  alt="4th element">  <FcAbout />  </a>

   <a href="https://app.shinixagami.net" target="_blank"  className="menu-item orange"  alt="3rd element">  <FcDiploma2 />  </a>

   <a href="https://landing.shinixagami.net/waveportal" target="_self" className="menu-item lightblue"   alt="2nd element">  <FcPrevious /> </a>
